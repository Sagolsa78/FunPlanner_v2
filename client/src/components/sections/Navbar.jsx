    ...
    <nav className="w-full bg-black border-b border-gray-800">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-center h-16">
          ...
          <div className="hidden md:block">
            <div className="ml-6 flex items-baseline space-x-4">
             <div className="flex items-center space-x-1">
                <NavigationItem href="#product" popupContent={popupData.product}>
                  Product
                </NavigationItem>
                <NavigationItem href="#resources" popupContent={popupData.resources}>
                  Resources
                </NavigationItem>
                <NavigationItem href="#pricing" popupContent={popupData.pricing}>
                  Pricing
                </NavigationItem>
                <NavigationItem href="#customers" popupContent={popupData.customers}>
                  Customers
                </NavigationItem>
          ...
          {/* Auth Buttons */}
          <div className="ml-36 hidden md:flex items-center space-x-4">
            <button
                 className="text-gray-300 hover:text-white block px-3 py-2 text-base font-medium transition-colors duration-200 cursor-pointer"
                 onClick={()=>{
                  loginHandler();
                 }}
                >
            ...
            <button
              ...
              className="bg-gray-300 text-gray-900 hover:bg-gray-100 px-4 py-1.5 text-sm font-medium rounded-lg transition-colors duration-200 inline-block cursor-pointer"
            >
              Sign up
            </button>
          </div>
          ...
          <div className="md:hidden">
            <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3 border-t border-gray-800">
              ...
              <div className="pt-4 pb-3 border-t border-gray-800">
                ...
                <a
                  href="/n"
                  className="bg-white text-black hover:bg-gray-100 block px-3 py-2 text-base font-medium rounded-md transition-colors duration-200 mx-3 mt-2 text-center"
                  onClick={() => setIsMobileMenuOpen(false)}
                >
                  Sign up
                </a>
